...
- `get_financial_metrics(ticker, end_date, period="annual", limit=5)` - ROIC, 마진
- `search_line_items(ticker, [...], end_date, period="annual", limit=5)` - FCF, 비용 구조
- `get_market_cap(ticker, end_date)` - 밸류에이션
- `get_insider_trades(ticker, end_date)` - 경영진 거래
