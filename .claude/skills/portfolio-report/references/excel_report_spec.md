...
- A18:B22의 **시가총액 분포 파이 차트**를 D17부터 삽입
...
| G | 점수 환산값 | +0.0% | predict 점수의 휴리스틱 환산값 |
| H | 시가총액 | 텍스트 | 시가총액 |
| I | P/E | 0.0 | 주가수익비율 |
| J | ROE | 0.0% | 자기자본이익률 |
...
- 현금 행과 마지막 **합계/평균 행** 포함 (주식+현금 100%, 신뢰도는 투자분 가중평균)
- 비중 열 기준 **내림차순 정렬**
