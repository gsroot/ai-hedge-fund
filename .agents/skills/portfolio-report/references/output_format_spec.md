...
데이터 소스  : predict + 독립 investor-analysis + 가격·시장국면 risk snapshot
══════════════════════════════════════════════════════════════════════════════════════════════
```
...
📊 포트폴리오 구성
══════════════════════════════════════════════════════════════════════════════════════════════
#   종목                     비중     시총       종합신호       신뢰도   점수환산값   P/E    ROE      합의
─────────────────────────────────────────────────────────────────────────────────────────────
...
─────────────────────────────────────────────────────────────────────────────────────────────
    주식 합계                75.0%                              avg 81%
    현금                    25.0%                              점수환산 기여 +12.2%
```

열 설명:
- **비중**: 포트폴리오 배분 비율 (주식+현금 합계 100%)
- **종합신호**: 투자자들의 가중 종합 판단
- **신뢰도**: 투자자 confidence 가중 평균
- **점수환산값**: predict 점수의 휴리스틱 환산값. 예상수익률이 아님
...
평균 신뢰도          : 81%
점수 환산 기여값     : +12.2% (예상수익률 아님)
시장 국면            : overheated (SPY, 2025-01-28)
시장 목표 현금       : 25.0%
현금 비중            : 25.0%
강력매수 비중        : 35.3%
매수 비중            : 39.7%
...
9. **현금비중**: 시장 목표 현금보다 작을 수 없다. 과열·공포·전망 점수와 기준일을 요약에 표시
